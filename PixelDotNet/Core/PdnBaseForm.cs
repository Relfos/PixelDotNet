          ...
          ISnapManagerHost
    {
        ...
        public virtual void LoadResources()
        {
            if (!this.DesignMode)
            {
                ...
                string stringValue = PdnResources.GetString(stringName);
        ...
        private void LoadLocalizedResources(string baseName, Control control)
        {
            ...
            string textString = PdnResources.GetString(textStringName);
            ...
            string locationString = PdnResources.GetString(locationStringName);
            ...
            string sizeString = PdnResources.GetString(sizeStringName);
