...
{
    public static class QuadrupleUtils
    {
    ...
    public struct Quadruple<T, U, V, W>
    {
        ...
        {
            return TripleUtils.Create<T, U, V>(this.first, this.second, this.third);
        }

        public Triple<U, V, W> GetTriple234()
        {
            return TripleUtils.Create<U, V, W>(this.second, this.third, this.fourth);
        }
