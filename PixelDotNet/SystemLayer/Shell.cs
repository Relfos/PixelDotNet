...
namespace PixelDotNet.SystemLayer
{
    public static class Shell
    {
        ...
        private static readonly Pair<VirtualFolderName, int>[] pathMappings = new Pair<VirtualFolderName, int>[]
            {
                PairUtils.Create(VirtualFolderName.SystemProgramFiles, NativeConstants.CSIDL_PROGRAM_FILES),
                PairUtils.Create(VirtualFolderName.UserDesktop, NativeConstants.CSIDL_DESKTOP_DIRECTORY),
                PairUtils.Create(VirtualFolderName.UserDocuments, NativeConstants.CSIDL_PERSONAL),
                PairUtils.Create(VirtualFolderName.UserLocalAppData, NativeConstants.CSIDL_LOCAL_APPDATA),
                PairUtils.Create(VirtualFolderName.UserPictures, NativeConstants.CSIDL_MYPICTURES),
                PairUtils.Create(VirtualFolderName.UserRoamingAppData, NativeConstants.CSIDL_APPDATA) 
            };
